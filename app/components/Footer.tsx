    ...
    return (
        ...
        <section className={" py-3 bg-[url('/fond-feuilles-gris.jpg')] bg-cover bg-center flex flex-col items-center pb-30 lg:flex-row lg:justify-center lg:py-3"}>
            ...
            <div className="flex flex-col items-center pb-3 lg:flex-1">
                ...
                <Link href={"/mentions"}><p className="underline">Mentions Légales</p></Link>
                <Link href={"/conditions"}><p className="underline">Conditions Générales de Vente</p></Link>
                <p>Contact en cas de réclamation:</p>
                <Link href={'mailto:contact@epistudios.fr'} className="underline">contact@epistudios.fr</Link>
            ...
            <div className={"flex flex-col items-center text-center pt-3 lg:flex-1"}>
                ...
                <Link href={"/recrutements"}><p className="underline">Rendez-vous sur cette page!</p> </Link>
