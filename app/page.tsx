                    ...
                    <section className={"lg:flex-row lg:flex lg:items-center lg:justify-center lg:gap-10"}>
                         <div className={"lg:flex lg:flex-col lg:items-center"}>
                              ...
                              <p className={"lg:text-lg lg:text-justify text-sm w-80 mx-auto text-center italic"}>
                                   ...
                                   Studio! Avec cette association, je veux pouvoir créer un environnement qui nous
                                   pousse à innover et à exercer notre passion - hors de l&#39;espace de travail
                                   stressant.<span className={"text-2xl font-extrabold"}>&#34;</span>{" "}
                              </p>
                         </div>
