               ...
               <main className={"min-h-screen"}>
                    <section>
                         ...
                         <p className={"text-center text-xl text-main mt-3 w-85 mx-auto lg:w-[70%]"}>
                              Depuis le lancement d&#39;EPI Studio, nous avons travaillé sur des projets Minecraft, des
                              applications PC/Mobile ainsi que des jeux-vidéos. Vous pouvez les télécharger directement
                              sur Github, ils sont gratuits!
                         </p>
                    </section>
                    ...
                    >
                         {MembresList.map((members, index) => {
                              return <MemberCard key={index} {...members} />
                         })}
                    </section>
                    <div
                         className={
